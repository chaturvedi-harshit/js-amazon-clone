...
const today = dayjs();
const twoDaysAfter = today.add(2, "days").format("dddd, MMMM DD");
// console.log(today.format("dddd, MMMM DD"));
...
<div class="cart-item-container js-cart-item-container-${matchingProduct.id}">
    ...
    cartItem.quantity
                  ...
                  <input type="text" class="quantity-input js-quantity-input"></input>
...
document.querySelectorAll(".js-save-quantity-link").forEach((link) => {
  link.addEventListener("click", () => {
    ...
    if (newQuantity < 0 || newQuantity > 50) {
      alert("Quantity must be at least 0 or less than 50");
      return;
    }
    updateQuantityOnCheckout(productId, newQuantity);
